...
class List extends React.Component {
    render() {
        return ( <
            >
            <
            PageTitle title = "Offers Near You"
            ...
            Col md = { 3 } >
            <
            div className = "filters shadow-sm rounded bg-dark-color mb-4" >
            <
            ...
            <
            div className = "filters-body rounded shadow-sm bg-dark-color" >
            <
            ...
            className = "mb-4 pb-2" >
            <
            CardItem title = "Bite Me Sandwiches"
