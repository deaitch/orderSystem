...
class Index extends React.Component {
  render() {
    return (
      <>
        <TopSearch />
        <section className="section pt-5 pb-5 bg-dark-color homepage-add-section">
          <Container>
            <Row>
              <Col md={3} xs={6}>
                <ProductBox
        ...
        <section className="section pt-5 pb-5 bg-dark-color becomemember-section border-bottom">
          <Container>
            <SectionHeading
