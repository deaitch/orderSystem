...
class BestSeller extends React.Component {
    ...
    IncrementItem = () => {
        if (this.state.quantity >= this.state.max) {} else {
            this.setState({
    ...
    DecreaseItem = () => {
        if (this.state.quantity <= this.state.min) {} else {
    ...
    render() {
        return ( <
            div className = "list-card bg-dark-color h-100 rounded overflow-hidden position-relative shadow-sm" >
            <
            ...
            <
            Link to = "#"
            className = "text-black" > { this.props.title } <
            /Link> <
            /h6> {
                this.props.subTitle ? ( <
                ...
                this.props.price ? ( <
...

                    {
                        this.state.quantity === 0 ? ( <
                            ...
                            <
                            /Button> <
                            input className = "count-number-input"
                            type = "text"
