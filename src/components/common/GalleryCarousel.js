...
class GalleryCarousel extends React.Component {
    ...
    render() {
        return ( <
            >
            <
            OwlCarousel ref = { this.Carousel }
            nav loop {...options }
            className = "owl-theme homepage-ad" >
            <
            div className = "item" >
            <
            ...
            div className = "position-absolute restaurant-slider-view-all" > < Button variant = 'light'
            type = "button"
            className = "bg-dark-color" > See all Photos < /Button></div >
            <
            />
        );
    }
