...
class Footer extends React.Component {
    render() {
        return ( <
            >
            <
            section className = "section pt-5 pb-5 text-center bg-dark-color" >
            <
            Container >
            <
            Row >
            ...
            />
            by <
            Link className = "text-danger ml-1"
            target = "_blank"
...
Footer.defaultProps = {
    sectionclassName: "footer-bottom-search pt-5 pb-5 bg-dark-color",
