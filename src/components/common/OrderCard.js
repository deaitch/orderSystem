...
class OrderCard extends React.Component {
    ...
    render() {
        return ( <
            div className = "bg-dark-color card mb-4 order-list shadow-sm" >
            <
            ...
            h6 className = "mb-2" >
            <
            Link to = { this.props.detailLink }
            className = "text-black" > { this.props.orderTitle } < /Link> <
            /h6> <
            ...
            className = "ml-2" / > { this.props.orderDate } <
            /p> <
            p className = "text-dark" > { this.props.orderProducts } <
            /p> <
            hr / >
            <
            div className = "float-right" >
            <
            Link className = "btn btn-sm btn-outline-primary mr-1"
            to = { this.props.helpLink } > < Icofont icon = "headphone-alt" / > HELP < /Link> <
            Link className = "btn btn-sm btn-primary"
            to = { this.props.detailLink } > < Icofont icon = "refresh" / > REORDER < /Link> <
            /div> <
