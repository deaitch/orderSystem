    ...
    return (
      <>
                ...
                <Col md={8}>
                  <div className="restaurant-detailed-header-left">
                    ...
                    <p className="text-white mb-1">
                      <Icofont icon="location-pin" /> 2036 2 ND AVE, NEW YORK,
                      NY 10029 <Badge variant="success"> OPEN </Badge>{" "}
                    </p>{" "}
        ...
        <Tab.Container defaultActiveKey="first">
          <section className="offer-dedicated-nav bg-dark-color border-top-0 shadow-sm">
            <Container>
              <Row>
                <Col md={12}>
          ...
          <section className="offer-dedicated-body pt-2 pb-2 mt-4 mb-4">
            <Container>
              <Row>
                    ...
                    <Tab.Content className="h-100">
                      <Tab.Pane eventKey="first">
                        ...
                        <Row>
                          ...
                          <Col md={12}>
                            <div className="bg-dark-color rounded border shadow-sm mb-4">
                              <QuickBite
                                id={1}
                        ...
                        <Row>
                          ...
                          <Col md={12}>
                            <div className="bg-dark-color rounded border shadow-sm">
                              <QuickBite
                                id={1}
                                title="Chicken Tikka Sub"
                                price={250}
                      ...
                      <Tab.Pane eventKey="third">
                        <div
                          id="restaurant-info"
                          className="bg-dark-color rounded shadow-sm p-4 mb-4"
                        >
                          ...
                          <p className="mb-3">
                            Jagjit Nagar, Near Railway Crossing, <br /> Near
                          ...
                          <p className="text-black mb-0">
                            You can also check the 3 D view by using our menue
                            map clicking here & nbsp; & nbsp; & nbsp;{" "}
                      ...
                      <Tab.Pane eventKey="fourth">
                        <div
                          id="book-a-table"
                          className="bg-dark-color rounded shadow-sm p-4 mb-5 rating-review-select-page"
                        >
                      ...
                      <Tab.Pane eventKey="fifth">
                        <div
                          ...
                          className="bg-dark-color rounded shadow-sm p-4 mb-4 clearfix restaurant-detailed-star-rating"
                        >
                        ...
                        <div className="bg-dark-color rounded shadow-sm p-4 mb-4 clearfix graph-star-rating">
                        ...
                        <div className="bg-dark-color rounded shadow-sm p-4 mb-4 restaurant-detailed-ratings-and-reviews">
                          <Link
                            to="#"
                        ...
                        <div className="bg-dark-color rounded shadow-sm p-4 mb-5 rating-review-select-page">
                ...
                <Col md={4}>
                  <div className="bg-dark-color rounded shadow-sm text-white mb-4 p-4 clearfix restaurant-detailed-earn-pts card-icon-overlap">
                    <Image
                      fluid
                  ...
                  <div className="generator-bg rounded shadow-sm mb-4 p-4 osahan-cart-item">
                    ...
                    <div className="bg-dark-color rounded shadow-sm mb-2">
                      <CheckoutItem
                    ...
                    <div className="mb-2 bg-dark-color rounded p-2 clearfix">
                      <Image
                        fluid
