...
class TopSearch extends React.Component {
    render() {
        return ( <
            ...
            <
            span className = "font-weight-bold" > Find Awesome Deals < /span> in Australia <
            /h1> <
            ...
            <
            OwlCarousel nav loop {...options2 }
            className = "homepage-ad owl-theme" >
            <
            div className = "item" >
            <
            ProductBox image = "img/slider.png"
            ...
            div className = "item" >
            <
            ProductBox image = "img/slider1.png"
            imageClass = "img-fluid rounded"
            imageAlt = "carousel"
            linkUrl = "listing" /
            >
