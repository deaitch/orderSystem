...
class Invoice extends React.Component {
    render() {
        return ( <
            ...
            className = "mx-auto" >
            <
            div className = "p-5 osahan-invoice bg-dark-color shadow-sm" >
            <
            ...
            Thanks
            for choosing <
            strong className = "text-secondary" > Osahan Eat < /strong>,
            Gurdeep!Here are your order details:
            <
            /h3> <
            /Col> <
            Col md = { 4 }
            ...
            Col md = { 6 } >
            <
            HeadingValue heading = "Order No:"
            value = "#25102589748"
            className = "text-black" /
            >
            <
            HeadingValue heading = "Order placed at:"
            value = "12/11/2018, 06:26 PM" /
            >
            <
            HeadingValue heading = "Order delivered at:"
            value = "12/11/2018, 07:18 PM" /
            >
            <
            HeadingValue heading = "Order Status:"
            value = "Delivered"
            ...
            Col md = { 6 } >
            <
            HeadingValue heading = "Delivery To:"
            className = "text-black" /
            >
            <
            HeadingValue className = "text-primary"
            value = "Gurdeep Singh Osahan" /
            >
            <
            HeadingValue heading = "291/d/1, 291, Jawaddi Kalan, Ludhiana, Punjab
            141002, India " /
            >
            <
            /Col> <
            ...
            Item Name <
            /th> <
            th className = "text-right text-black font-weight-bold"
            scope = "col" >
            Quantity <
            /th> <
            th className = "text-right text-black font-weight-bold"
