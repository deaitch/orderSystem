          ...
          <Row>
            <Col md={8}>
              <div className="offer-dedicated-body-left">
                <div className="bg-dark-color rounded shadow-sm p-4 mb-4">
                ...
                <div className="pt-2"></div>
                <div className="bg-dark-color rounded shadow-sm p-4 osahan-payment">
                      ...
                      <Col sm={8} className="pl-0">
                        <Tab.Content className="h-100">
                          ...
                          <Tab.Pane eventKey="third">
                            <div className="border shadow-sm-sm p-4 d-flex align-items-center bg-dark-color mb-3">
                              <Icofont
                                icon="apple-pay-alt"
                            ...
                            <div className="border shadow-sm-sm p-4 d-flex bg-dark-color align-items-center mb-3">
                              <Icofont
                                icon="paypal-alt"
                                className="mr-3 icofont-3x"
                              />
                            ...
                            <div className="border shadow-sm-sm p-4 d-flex bg-dark-color align-items-center">
                              <Icofont
                                icon="diners-club"
                                className="mr-3 icofont-3x"
                              />
                              <div className="d-flex flex-column">
                                ...
                                <p className="card-text">
                                  Diners Club lets you order now & pay later at
                                  no extra cost.
                                </p>
                                <Link
                                  to="#"
