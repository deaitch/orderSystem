...
class TrackOrder extends React.Component {
    ...
    render() {
        return ( <
            section className = "section bg-dark-color osahan-track-order-page position-relative" >
            <
            ...
            Col md = { 6 } >
            <
            div className = "bg-dark-color p-4 shadow-lg mb-2" >
            <
            div className = "mb-2" > < small > Order #25102589748<Link className= "float-right font-weight-bold"
            to = "#" > < Icofont icon = "headphone-alt" / > HELP < /Link></small > < /div> <
            h6 className = "mb-1 mt-1" >
            <
            Link to = "/detail"
            className = "text-black" > Spice Hut Restaurant <
            /Link> <
            /h6> <
            p className = "text-gray mb-0" > < Icofont icon = "clock-time" / > 04: 19 PM | 8 Items | $314 < /p> <
            /div> <
            div className = "bg-dark-color p-4 shadow-lg" >
            <
            ...
            <
            small > FROM < /small> <
            h6 className = "mb-1 mt-1" > < Link to = "/detail"
            className = "text-black" > < Icofont icon = "food-cart" / > Spice Hut Restaurant <
            /Link> <
            /h6> <
            ...
            <
            CartDropdownItem icoIcon = 'ui-press'
            ...
            /div> <
            /div> <
            div className = "bg-dark-color p-4 shadow-lg mt-2" >
            <
            ...
            <
            Icofont icon = "tasks"
            className = "icofont-3x text-info" / >
            <
