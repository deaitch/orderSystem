...
class Addresses extends React.Component {
    ...
    render() {
        return ( <
            >
            <
            AddAddressModal show = { this.state.showAddressModal }
            onHide = { this.hideAddressModal }
            /> <
            DeleteAddressModal show = { this.state.showDeleteModal }
            onHide = { this.hideDeleteModal }
            /> <
            div className = 'p-4 bg-dark-color shadow-sm' >
            <
            Row >
            <
            Col md = { 12 } >
            ...
            Col md = { 6 } >
            <
            AddressCard boxClass = "border border-primary shadow"
            title = 'Home'
            icoIcon = 'ui-home'
            ...
            Col md = { 6 } >
            <
            AddressCard boxClass = "shadow-sm"
            title = 'Work'
            icoIcon = 'briefcase'
            iconclassName = 'icofont-3x'
